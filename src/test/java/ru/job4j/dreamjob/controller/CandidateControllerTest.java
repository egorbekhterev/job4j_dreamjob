...
class CandidateControllerTest {
    ...
    @Test
    public void whenRequestCandidateListPageThenGetPageWithVCandidates() {
    ...
    public void whenRequestCandidateByIdThenGetCandidatePageWithCities() {
        ...
        when(candidateService.findById(any(Integer.class))).thenReturn(candidate);
        when(cityService.findAll()).thenReturn(expectedCities);
        ...
        assertThat(actualCandidate).isEqualTo(candidate.get());
        assertThat(actualCities).isEqualTo(expectedCities);
    }

    @Test
    public void whenRequestCandidateByIdThenEmptyAndRedirectToErrorPage() {
    ...
    @Test
    public void whenRequestCandidateByIdThenDeleteItSuccessfully() {
    ...
    @Test
    public void whenRequestNonExistingCandidateByIdThenDeleteItWithError() {
    ...
    @Test
    public void whenUpdateCandidateWithFileThenSameDataNotFoundAndRedirectToErrorPage() {
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenUpdateCandidateWithFileThenSameDataAndRedirectToErrorPage() {
