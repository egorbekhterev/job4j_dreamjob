...
class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdThenGetVacancyPageWithCities() {
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        var vacancy = Optional.of(new Vacancy(1, "test1", "desc1", now(), true, 1, 2));

        when(vacancyService.findById(any(Integer.class))).thenReturn(vacancy);
        when(cityService.findAll()).thenReturn(expectedCities);
        ...
        assertThat(actualVacancy).isEqualTo(vacancy.get());
        assertThat(actualCities).isEqualTo(expectedCities);
    }

    @Test
    public void whenRequestVacancyByIdThenEmptyAndRedirectToErrorPage() {
    ...
    @Test
    public void whenRequestVacancyByIdThenDeleteItSuccessfully() {
    ...
    @Test
    public void whenRequestNonExistingVacancyByIdThenDeleteItWithError() {
    ...
    @Test
    public void whenUpdateVacancyWithFileThenSameDataNotFoundAndRedirectToErrorPage() {
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenUpdateVacancyWithFileThenSameDataAndRedirectToErrorPage() {
