...
class Sql2oCandidateRepositoryTest {
    ...
    public void clearVacancies() {
        var candidates = sql2oCandidateRepository.getAll();
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name2", "description2", creationDate, 3, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "name3", "description3", creationDate, 2, file.getId()));
        var result = sql2oCandidateRepository.getAll();
        assertThat(result).isEqualTo(List.of(candidate1, candidate2, candidate3));
    }

    @Test
    public void whenDontSaveThenNothingFound() {
        assertThat(sql2oCandidateRepository.getAll()).isEqualTo(emptyList());
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(candidate.getId(), "new name", "new description",
                creationDate.minusDays(5), 2, file.getId());
